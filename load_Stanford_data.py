...
def mat_to_npy(folder='Stanford_Dataset', sep=10):
    ...
    """
    # 去除有問題的cycle
    ignore_dict = {'G1':[29], 'V4':[69], 'V5':[], 'W4':[], 'W5':[192], 'W8':[], 'W9':[137], 'W10':[]}
...
def data_visualization(folder, cell_id):
...
def main():
    ...
    data_visualization('Stanford_Dataset/discharge_info', 'V5')
